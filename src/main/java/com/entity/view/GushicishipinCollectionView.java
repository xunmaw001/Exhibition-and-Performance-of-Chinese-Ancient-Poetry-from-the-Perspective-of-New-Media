...
public class GushicishipinCollectionView extends GushicishipinCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String gushicishipinCollectionValue;
	...
	public GushicishipinCollectionView() {

	}

	public GushicishipinCollectionView(GushicishipinCollectionEntity gushicishipinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, gushicishipinCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getGushicishipinCollectionValue() {
				return gushicishipinCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setGushicishipinCollectionValue(String gushicishipinCollectionValue) {
				this.gushicishipinCollectionValue = gushicishipinCollectionValue;
			}
