var projectName = '新媒体视域下的中国古诗词展演';
/**
 * 轮播图配置
 */
var swiper = {
...
var centerMenu = [
    ...
    ,{
        name: '古诗词视频收藏',
        url: '../gushicishipinCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '古诗词视频',
        url: './pages/gushicishipin/list.html'
    },
    {
        name: '公告信息',
...
var adminurl =  "http://localhost:8080/zhongguogushicizhanyan/admin/dist/index.html#/login";
